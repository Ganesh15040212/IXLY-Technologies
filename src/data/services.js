export const services = [
  { slug: 'ecommerce', label: 'Ecommerce', title: 'Ecommerce', description: 'Custom eCommerce Website Development – Build tailored online stores.' },
  { slug: 'cloud', label: 'Cloud', title: 'Cloud', description: 'Cloud Consulting & Strategy – Expert guidance on cloud adoption and migration.' },
  { slug: 'aimachine', label: 'AI and ML', title: 'AI and ML', description: 'AI Consulting & Strategy – Expert guidance on AI adoption and implementation.' },
